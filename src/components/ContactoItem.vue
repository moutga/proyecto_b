...
export default {
	...
	computed: {},
	methods: {
		//* Se ejecuta al presionar el botón de borrar
		//* emite hacia ContactosList.vue la id del usuario que quiero borrar vía enviaContactoId
		borrarEste: function(){

			this.$emit('enviaContactoId',this.id);
...
<style  scoped>  
.usuarioItem{margin-top:4px !important;margin-bottom:0px !important;}
</style>